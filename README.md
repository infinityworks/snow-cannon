...
### Resource naming
Many resources like the remote state bucket and lock table include the project name in the resource. I suggest you do a find and replace of `iw-snowflake-demo` with your project name to replace all instances.
