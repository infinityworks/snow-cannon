...
output "storage_integration_external_id" {
  value = snowflake_storage_integration.storage_integration.storage_aws_external_id
}

output "storage_integration_snowflake_arn" {
  value = snowflake_storage_integration.storage_integration.storage_aws_iam_user_arn
}
